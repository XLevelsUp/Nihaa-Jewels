...
export const metadata: Metadata = {
  title: "Exquisite Gold & Diamond Rings",
  description: "Explore Coimbatore's finest collection of statement rings. From engagement bands to traditional gold rings, each piece is handcrafted to perfection.",
};
    ...
    <div className="bg-[#121212] min-h-screen">
      ...
      <main className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
        <header className="mb-12">
          ...
          <h1 className="text-4xl md:text-5xl text-[#FAF9F6] font-playfair">Signature <em className="text-gradient-gold not-italic">Rings</em></h1>
