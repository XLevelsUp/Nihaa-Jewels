...
export default function TermsAndConditions() {
  return (
    <Box sx={{ bgcolor: "#FFFFF0", color: "#2A2520", minHeight: "100vh", pt: 16, pb: 8 }}>
      <Container maxWidth="md">
        ...
        <Typography variant="body1" sx={{ fontFamily: "var(--font-inter)", color: "#2A2520", mb: 6, textAlign: "center" }}>
          Last Updated: {new Date().toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}
        </Typography>

        <Box sx={{ display: "flex", flexDirection: "column", gap: 5 }}>
          <Box>
            <Typography variant="h5" sx={{ fontFamily: "var(--font-playfair-display)", color: "#5F6440", mb: 2 }}>
              1. General Agreement
            </Typography>
            <Typography variant="body1" sx={{ fontFamily: "var(--font-inter)", color: "rgba(85, 82, 74, 0.8)", lineHeight: 1.8, textAlign: "justify" }}>
