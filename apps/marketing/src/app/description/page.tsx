...
export default function DescriptionPage() {
  return (
    <Box sx={{ bgcolor: "#FFFFF0", color: "#2A2520", minHeight: "100vh", pt: 16, pb: 12 }}>
      <Container maxWidth="md">
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 6 }}>
          <Box>
            <Typography variant="h4" sx={{ fontFamily: "var(--font-playfair-display)", color: "#5F6440", mb: 2, fontSize: "1.8rem" }}>
              The Legacy of Nihaa Jewels
            </Typography>
            <Typography variant="body1" sx={{ fontFamily: "var(--font-inter)", color: "rgba(85, 82, 74, 0.8)", lineHeight: 1.9, textAlign: "justify", fontSize: "1.05rem" }}>
