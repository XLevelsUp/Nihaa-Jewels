...
export default function DailyWearClient() {
    ...
    <Box sx={{ bgcolor: 'background.default', minHeight: '100vh' }}>
      ...
      <Container component="main" maxWidth="lg" sx={{ pt: 20, pb: 12, px: 3 }}>
        ...
        >
          ...
          >
            Our exquisite collection of lightweight gold jewellery, everyday gold, and elegant office wear gold is being curated and will be unveiled shortly.
          </Typography>
        </Box>
      </Container>
      <Footer />
