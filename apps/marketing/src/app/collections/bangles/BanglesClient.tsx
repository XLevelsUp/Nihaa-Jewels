...
export default function BanglesClient() {
    ...
    <Box sx={{ bgcolor: 'background.default', minHeight: '100vh' }}>
      ...
      <Container component="main" maxWidth="lg" sx={{ pt: 20, pb: 12, px: 3 }}>
        ...
        >
          ...
          >
            Our exquisite collection of gold bangles, bridal bangles, and impon bangles is being curated and will be unveiled shortly.
          </Typography>
        </Box>
      </Container>
      <Footer />
